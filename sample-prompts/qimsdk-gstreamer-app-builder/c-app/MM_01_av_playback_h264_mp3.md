Create a QIM SDK C app for an audio-video playback pipeline that plays back an MP4 file containing H.264 video and MP3 audio, displaying video on screen and playing audio through the speaker.

## Pipeline Behavior
- Read an MP4 file containing H.264 video and MP3 audio tracks
- Demux into separate video and audio streams using a named demuxer with dynamic pad callbacks
