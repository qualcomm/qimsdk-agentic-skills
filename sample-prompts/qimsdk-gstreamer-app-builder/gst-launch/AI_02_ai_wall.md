Create a QIM SDK `gst-launch-1.0` command for an AI wall pipeline running four parallel AI inference streams composed into a 2x2 grid display.
...
## Configuration
- Input:       $HOME/Downloads/qimsdk_samples/media/Draw_1080p_180s_30FPS.mp4 (used for all four streams)
...
Stream 2 — Face Detection:
- Model:      $HOME/Downloads/qimsdk_samples/models/face_det_lite_w8a8.tflite
- Labels:     $HOME/Downloads/qimsdk_samples/labels/face_det_lite.json
- Results:    6

Stream 3 — Segmentation:
- Model:      $HOME/Downloads/qimsdk_samples/models/deeplabv3_plus_mobilenet_w8a8.tflite
- Labels:     $HOME/Downloads/qimsdk_samples/labels/dv3-argmax.json
- Alpha blend: 0.5
