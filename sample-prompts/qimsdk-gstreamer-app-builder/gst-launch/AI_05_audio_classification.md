Create a QIM SDK `gst-launch-1.0` command for an audio classification pipeline that classifies audio events from a video file and overlays results on the video.
...
## Configuration
- Input:        $HOME/Downloads/qimsdk_samples/media/H264_720p_30fps_FLAC.mp4
- Model:        $HOME/Downloads/qimsdk_samples/models/yamnet.tflite
- Labels:       $HOME/Downloads/qimsdk_samples/labels/yamnet.json
- Confidence:   10.0
- Results:      3
- Sample rate:  16000
- Feature:      lmfe
