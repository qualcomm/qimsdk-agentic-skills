Create a QIM SDK Python app for single-stream object detection from an MP4 file, encoding the result to a file.
...
- Confidence: 51.0
- Output:     encode to file at /root/Downloads/qimsdk_samples/media/output/obj_detect_out.mp4
