# QIM SDK Python Sample Prompts

These prompts are for the `qimsdk-python-app-builder` skill and generate Python `qimsdk` app artifacts.
...
Scope note: `qimsdk-python-app-builder` supports Python `qimsdk` apps only.
