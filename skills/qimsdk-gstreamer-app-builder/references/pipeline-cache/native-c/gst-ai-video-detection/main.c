 ...
 */
#define DESCRIPTION \
  "This application sets up a GStreamer pipeline for object detection using a "\
  "quantized YOLOv8 model. It supports various video input sources and output types."
