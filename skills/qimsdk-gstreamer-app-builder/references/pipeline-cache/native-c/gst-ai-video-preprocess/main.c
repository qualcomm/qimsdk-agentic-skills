 ...
 */
#define DESCRIPTION \
  "This application sets up a GStreamer pipeline for video preprocessing and tensor extraction. " \
  "It captures video input, converts frames into tensors using qtimlvconverter, and outputs the " \
  "inference-ready data to a file via appsink for further processing. " \
